 ...
 */
#define LL_ACCESS_GROUP_FS_READ (LL_ACCESS_FS_READ_FILE_BIT | LL_ACCESS_FS_READ_DIR_BIT)

/**
 * @brief Convenience filesystem write access group.
 */
#define LL_ACCESS_GROUP_FS_WRITE (LL_ACCESS_FS_WRITE_FILE_BIT | LL_ACCESS_FS_REMOVE_DIR_BIT | \
                                  LL_ACCESS_FS_REMOVE_FILE_BIT | LL_ACCESS_FS_MAKE_CHAR_BIT | \
                                  LL_ACCESS_FS_MAKE_DIR_BIT | LL_ACCESS_FS_MAKE_REG_BIT |     \
                                  LL_ACCESS_FS_MAKE_SOCK_BIT | LL_ACCESS_FS_MAKE_FIFO_BIT |   \
                                  LL_ACCESS_FS_MAKE_BLOCK_BIT | LL_ACCESS_FS_MAKE_SYM_BIT |   \
                                  LL_ACCESS_FS_REFER_BIT)

/**
 * @brief Convenience filesystem execute access group (includes read).
 */
#define LL_ACCESS_GROUP_FS_EXECUTE (LL_ACCESS_FS_EXECUTE_BIT | LL_ACCESS_GROUP_FS_READ)
 ...
 */
#define LL_ACCESS_GROUP_NET_CONNECT (LL_ACCESS_NET_CONNECT_TCP_BIT)

/**
 * @brief Convenience network bind access group.
 */
#define LL_ACCESS_GROUP_NET_BIND (LL_ACCESS_NET_BIND_TCP_BIT)
